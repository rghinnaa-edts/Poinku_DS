...
//  Poinku-DS
//
//  Created by Rizka Ghinna Auliya on 23/04/25.
//
...
class LoginViewController: UIViewController {
    ...
    private func setupUI() {
        ...
        lblToolbar.text = "Login"
        lblTitle.text = "Halo"
        lblDesc.text = "Silakan masukkan nomor handphone aktif kamu yang terdaftar di aplikasi Indomaret Poinku."
        lblTnC.text = "Dengan menggunakan aplikasi Indomaret Poinku, saya menyetujui syarat dan ketentuan"
        
        lblToolbar.font = Font.Heading.H1.font
    ...
    @objc private func textFieldDidChange(_ notification: Notification) {
        if let textField = notification.object as? UITextField {
            setupButton(isEnabled: !(textField.text?.isEmpty ?? true))
        }
    }
